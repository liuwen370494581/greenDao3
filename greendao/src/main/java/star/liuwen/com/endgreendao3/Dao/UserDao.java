...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Six = new Property(5, String.class, "six", false, "SIX");
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5) // six
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setSix(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
     }
